...
QUESTION_MAP = {
    ...
    "q2": "2) ความรู้สึกของน้องหลังจากผ่านกิจกรรมที่ท้าทาย/ยาก/ไม่ถนัด เป็นอย่างไรบ้าง",
...
5. Roadmap การพัฒนาตนเอง อยากให้พูดถึงแนวทางกิจกรรม/การศึกษาเพิ่มเติม/การปรับตัวอย่างละเอียดให้เห็นภาพ โดยให้คำนวณเวลาด้วยจากระดับชั้น เช่น ม.5 เหลืออีก 2 ปี ม.6 เหลืออีก 1 ปี
การสอบ NETSAT และ ALEVEL ตามข้อมูลในลิงก์นี้ https://www.smartmathpro.com/article/netsat-preparation/ และ https://www.smartmathpro.com/article/what-is-alevel/
- วันที่สอบ: [ระบุวัน]
- วันนี้คือ: [ระบุวันปัจจุบัน]
- พื้นฐานปัจจุบัน: [อ่อน/กลาง/ดี + รายละเอียด]
- เป้าหมายคะแนน: [ถ้ามี]

สิ่งที่ต้องการ:
1. แผนรายสัปดาห์จนถึงวันสอบ
2. ระบุว่าควรใช้เวลาเตรียมตัวรวมกี่ชั่วโมง
3. แบ่งช่วง (เช่น ปูพื้นฐาน / ฝึกโจทย์ / ทบทวน / ทำข้อสอบเก่า)
4. แนะนำว่าแต่ละช่วงควรโฟกัสอะไร
5. ใส่ buffer หรือวันพักให้ด้วย
6. ถ้าเวลาไม่พอ ให้แนะนำแผนเร่งรัด

ขอคำตอบแบบละเอียดและเป็นขั้นตอน
   - ระยะสั้น (0-3 เดือน)
   - ระยะกลาง (6-12 เดือน)
